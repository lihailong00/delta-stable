...
class ExecutionRouterTests(unittest.TestCase):
    def test_router_chooses_mode_and_fallback_exchange(self) -> None:
        ...
        self.assertEqual(decision.mode, "maker")
        self.assertEqual(decision.exchange, "okx")


class PairExecutorTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_partial_fill_triggers_adjustment_order(self) -> None:
        ...
        self.assertEqual(result.adjustments[0].order_id, "b2")
    ...
    async def test_failed_second_leg_rolls_back_first_leg(self) -> None:
        ...
        self.assertEqual(client_a.canceled, ["a1"])
