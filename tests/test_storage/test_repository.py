...
class RepositoryTests(unittest.TestCase):
    ...
    def test_initialize_creates_schema_tables(self) -> None:
        ...
        self.assertTrue({"orders", "fills", "positions", "funding_snapshots", "ticks"}.issubset(tables))
    ...
    def test_save_funding_and_query_history(self) -> None:
        ...
        self.assertEqual(history[0]["rate"], "0.0003")
