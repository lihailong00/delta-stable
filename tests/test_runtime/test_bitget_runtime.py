...
class BitgetRuntimeTests(unittest.IsolatedAsyncioTestCase):
    async def test_public_ping_uses_live_http_transport(self) -> None:
        ...
        self.assertEqual(client.calls[0][1], "https://api.bitget.com/api/v2/public/time")
                ...
                _Response(
                    {
                        "code": "00000",
                        "data": [
                            {"coin": "USDT", "available": "100.5", "frozen": "1.5", "locked": "0"},
    ...
    async def test_private_login_and_orderbook_stream(self) -> None:
        ...
        sockets = {
            "wss://ws.bitget.com/v2/ws/public": public_ws,
            "wss://ws.bitget.com/v2/ws/private": private_ws,
        }
    ...
    async def test_stream_funding_uses_public_ws_subscription(self) -> None:
        ...
        self.assertEqual(ws.sent[0]["args"][0]["channel"], "ticker")
        self.assertEqual(events[1]["channel"], "funding.update")
        self.assertEqual(events[1]["payload"]["symbol"], "BTC/USDT")
