...
class BaseExchangeClientTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_dummy_exchange_contract(self) -> None:
        ...
        self.assertEqual(request["headers"]["X-Test-Signature"], "GET:/ping:123")
        ...
        self.assertEqual(ticker.exchange, "dummy")
        self.assertEqual(balances["USDT"], Decimal("1000"))
        self.assertEqual(set(batch), {"BTC/USDT", "ETH/USDT"})
