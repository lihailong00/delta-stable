...
class BitgetWebSocketTests(unittest.TestCase):
    ...
    def test_builds_login_message(self) -> None:
        ...
        self.assertEqual(payload["args"][0]["passphrase"], "pass")
    ...
    def test_parses_ticker_and_funding_messages(self) -> None:
        ...
        self.assertEqual(events[1].payload["funding_rate"], Decimal("0.0001"))
